...
> **Provenance:** Vendored from [Community-Access/accessibility-agents](https://github.com/Community-Access/accessibility-agents) (`codex-skills/forms-specialist`), MIT License. Platform-specific tool/delegation references map to their Claude Code equivalents.
>
> **Why this skill matters for testadhd.ro:** the ASRS questionnaire (`components/test/Questionnaire.tsx`) is the only interactive feature — a multi-question radio-group form. Fieldset/legend grouping, label association, and accessible validation/progress apply directly here.
