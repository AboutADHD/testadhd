...
> **Provenance:** Vendored from [Community-Access/accessibility-agents](https://github.com/Community-Access/accessibility-agents) (`codex-skills/cognitive-accessibility`), MIT License. Platform-specific tool/delegation references map to their Claude Code equivalents.
>
> **Why this skill matters for testadhd.ro:** the entire audience is adults self-screening for ADHD — plain language, reduced cognitive load, and clear error/result wording are core product concerns, not nice-to-haves.
