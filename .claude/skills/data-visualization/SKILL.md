...
<!-- Vendored 2026-06-23 from https://github.com/NTCoding/claude-skillz/tree/main/data-visualization (no LICENSE file in source repo — used here for private, non-redistributed use only). Framework-agnostic dataviz craft; this project has no chart lib, so apply the principles with hand-rolled SVG/Tailwind or add Recharts only if a real need appears. -->
